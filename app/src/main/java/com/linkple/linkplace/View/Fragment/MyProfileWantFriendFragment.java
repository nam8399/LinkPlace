...
import com.linkple.linkplace.databinding.FragmentMyProfileWantFriendBinding;
...
public class MyProfileWantFriendFragment extends Fragment {
    private FragmentMyProfileWantFriendBinding binding;
    ...
    public MyProfileWantFriendFragment() {
        // Required empty public constructor
    }

    public static MyProfileWantFriendFragment newInstance() {
        return new MyProfileWantFriendFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentMyProfileWantFriendBinding.inflate(getLayoutInflater());
    ...
    private void listenerSetting() {
        binding.inputwantfriendbtn.setEnabled(false);
        ...
        binding.inputwantfriendbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), MyProfileActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                addProfileData(name, age, gender, job, charactor, hobby, clickmanage(), imageUrl, education, religion, drink, smoke, pet, introduce, career);
    ...
    private void wantfriendbtnEnable() {
        if (selectCount > 1 && selectCount < 11) {
            binding.inputwantfriendbtn.setEnabled(true);
            binding.inputwantfriendbtn.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#2B87F4")));
        } else {
            binding.inputwantfriendbtn.setEnabled(false);
            binding.inputwantfriendbtn.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#C4DFFF")));
        }
    }
