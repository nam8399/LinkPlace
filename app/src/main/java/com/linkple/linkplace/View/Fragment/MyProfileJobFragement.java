...
import com.linkple.linkplace.databinding.FragmentMyProfileJobFragementBinding;
...
public class MyProfileJobFragement extends Fragment {
    private FragmentMyProfileJobFragementBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentMyProfileJobFragementBinding.inflate(getLayoutInflater());
