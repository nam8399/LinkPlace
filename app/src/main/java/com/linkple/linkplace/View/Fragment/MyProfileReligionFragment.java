...
import com.linkple.linkplace.databinding.FragmentMyProfileReligionBinding;
...
public class MyProfileReligionFragment extends Fragment {
    FragmentMyProfileReligionBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentMyProfileReligionBinding.inflate(getLayoutInflater());
    ...
    private void listenerSetting() {
        binding.inputreligionbtn.setEnabled(false);
        ...
        binding.inputreligionbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void religionbtnEnable() {
        binding.inputreligionbtn.setEnabled(true);
        binding.inputreligionbtn.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#2B87F4")));
    }
